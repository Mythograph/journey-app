...
export const CHANNEL_DESCRIPTIONS: Record<string, string> = {
  ...
  // Throat ↔ G
  "7-31": "The leadership channel between Throat and G. People look to you for direction, in the future-forward sense. The gift is leading by being recognized, with the position offered rather than seized. The shadow is forcing the role when the invitation hasn't arrived, which makes the leadership land as control instead.",
...
export const TYPE_DESCRIPTIONS: Record<HdType, string> = {
  ...
  "Projector": "Projectors are about 20% of people. You are designed to guide, to read, and to see patterns other people miss. Your strategy is to wait for the invitation; recognition that comes to you is real, and chasing it does not work. The invitation can be small (a question, an opening, a 'what do you think?') or large (a job, a partnership, a marriage). When recognized, your guidance lands. Without recognition, it grates.",
...
export const AUTHORITY_DESCRIPTIONS: Record<Authority, string> = {
  ...
  "Self-Projected": "Your truth lives in the throat after passing through the G center. Your identity speaks itself out loud when you have someone to speak to. Talk it through with someone who only listens, no advice, no opinions. Hearing yourself is how you find out what your design wants you to do.",
...
export const PROFILE_DESCRIPTIONS: Record<string, string> = {
  ...
  "5/1": "Consciously, you are the Heretic: you see yourself as someone with practical solutions, called in to fix what others can't. Unconsciously, others experience you as the Investigator: the depth of your study and foundation. They project the savior role onto you, and you can deliver because the foundation is there. The shadow is being projected onto without the foundation actually being in place yet, or hiding behind the foundation when the call to deliver comes.",
