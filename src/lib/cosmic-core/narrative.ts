...
My nature: I am a ${typeLabel}${typeQuantum ? ` (a ${typeQuantum})` : ""}. I am here to serve by ${typePurpose}. This is not a strategy I'm adopting — it is how my energy functions at its best.
