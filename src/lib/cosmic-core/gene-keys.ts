...
export const SPHERE_LINE_EXPRESSIONS: Record<string, Record<number, SphereLineExpression>> = {
  ...
  lifesWork: {
    ...
    3: { name: "Charger",  description: "You are here to be unpredictable, big and colourful. You need to challenge yourself and take risks — you are not about being normal. Feel safety in trying and failing." },
  ...
  purpose: {
    ...
    5: { name: "Voice",   description: "Your purpose is in the vibrational frequency of your voice. You need to vocalise — sing, speak, chant. Your voice brings things into existence and complaining lowers your vibration. When out of alignment, you will experience throat inflammation." },
    6: { name: "Aura",    description: "Your purpose fulfilment comes from realising that your aura speaks loudly. Your energy does the work for you. Your intention sets your aura. People feel your intention via your work simply because your energy speaks loudly. You can also read others' auras acutely." },
  },
  // Venus Sequence
  attraction: {
    ...
    4: { name: "Romance",      description: "Shadow: Can be emotionally distant and unavailable, very sensitive to the tone of conversations. Gift: Romanticise everything into a state of gentleness. Your desires may intimidate others." },
  ...
  iq: {
    ...
    5: { name: "The Practical Mind",     description: "The mind is a catalyst for dynamic change and transformation. It is organised so everyone has access to the answers. The shadow is defensive and puts up walls, feeling like the world is against it." },
  ...
  eq: {
    ...
    6: { name: "Reverence",    description: "A voyage of emotional discovery that brings wisdom. Reverence honours the long term relationship with emotions. Alienation will happen easily and cause you to feel distant, separated and cut off." },
  },
  sq: {
  ...
  core: {
    ...
    5: { name: "Guilt Healed Through Forgiveness",     description: "Guilt around power — being powerless or exerting power. Manipulation, guilt tripping and gaslighting behaviour occurs. Forgiving yourself and others is the key to healing." },
  ...
  pearl: {
    ...
    2: { name: "Recognition",  description: "Your relationship to money is about being seen and recognised. Being seen as yourself and for how valuable you are. Receiving money feels like recognition. How much money does it take to make you feel valuable and recognised?" },
    ...
    4: { name: "Charity",      description: "Your relationship to money is about service to others. The more money you have, the more you can help others. There is a distinct frequency of gratitude. How much money do I need to truly help others in the way I feel called to?" },
    ...
    6: { name: "Nature",       description: "Your relationship to money is about nature. Money and nature are the same frequency for you. You are one with money and abundance. What is the vibrational frequency of financial abundance and how can I embody it?" },
  },
};
