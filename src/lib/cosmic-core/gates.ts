...
export const GATES: Record<number, Gate> = {
  1: {
    ...
    high: {
      ...
      expanded: "An innate orientation toward true self-knowledge that functions as a compass. Purpose stops being a burden and becomes a reliable internal anchor.",
  ...
  5: {
    ...
    high: {
      ...
      expanded: "Consistency that comes from alignment rather than willpower, routines that are actually expressions of your true self, easy to maintain because they belong to you.",
  ...
  6: {
    ...
    high: {
      short: "maintaining an emotional tone that creates peace, equity, and genuine influence",
      expanded: "An ability to hold an elevated, steady emotional state that shapes the environment, generating peace, equity, and sustainable relating. Influence through alignment rather than force.",
      verb: "maintain an emotional tone that creates peace, equity, and genuine influence",
      gerund: "maintaining an emotional tone that creates peace, equity, and genuine influence",
    },
    arc: {
  ...
  11: {
    ...
    low: {
      short: "trying to build every idea that passes through me, exhausting myself as a builder of everything",
      ...
      verb: "try to build every idea that passes through me, exhausting myself as a builder of everything",
      gerund: "trying to build every idea that passes through me, exhausting myself as a builder of everything",
    },
    high: {
  ...
  29: {
    ...
    high: {
      short: "the ability to commit fully to the right thing, and to know the difference by sensing genuine alignment",
      ...
      verb: "commit fully to the right thing and know the difference by sensing genuine alignment",
      gerund: "committing fully to the right thing and knowing the difference by sensing genuine alignment",
    },
    arc: {
      short: "moving from indiscriminate over-commitment to a devotion that comes from genuine alignment",
      ...
      verb: "move from indiscriminate over-commitment to a devotion that comes from genuine alignment",
      gerund: "moving from indiscriminate over-commitment to a devotion that comes from genuine alignment",
    },
    storyParagraph: "When conditioned, Gate 29 over-commits, saying yes to everything, burning out, staying in things long past their natural end because letting go feels like failure. The high expression is the ability to respond: to commit fully to the right thing, and to know what that is by sensing genuine alignment rather than obligation. Your devotion, when it's real, changes the direction of a life, yours and others'.",
  },
  30: {
  ...
  47: {
    ...
    low: {
      short: "quitting when I can't figure out how to make something happen, feeling defeated by ideas I can't make real",
      ...
      verb: "quit when I can't figure out how to make something happen, feeling defeated by ideas I can't make real",
      gerund: "quitting when I can't figure out how to make something happen, feeling defeated by ideas I can't make real",
    },
    high: {
      short: "maintaining inspired, hopeful thought as a practice regardless of what's happening around me",
      expanded: "An understanding that the orientation of the mind toward possibility, independent of current circumstances, is what calibrates the emotional tone that attracts the how. You don't need to know the mechanism; you need to keep believing in the direction.",
    ...
    storyParagraph: "Conditioned, Gate 47 quits when it can't figure out how, treating the absence of a clear path as evidence that the vision isn't possible. The shift is in maintaining inspired, hopeful thought regardless of outer circumstances. Your mind's orientation toward possibility calibrates your emotional tone, and that tone is what actually draws in the how. You don't need to know the mechanism; you need to keep believing in the direction.",
  },
  48: {
  ...
  53: {
    ...
    high: {
      ...
      expanded: "The ability to sense when an idea is genuinely ready to be launched, and to begin from that alignment with confidence, trusting that what is initiated at the right moment carries its own momentum.",
  ...
  54: {
    ...
    low: {
      ...
      expanded: "A compulsion to take every incoming inspiration and push it into form, even when the idea isn't yours to build, or when the timing isn't aligned, resulting in exhaustion and diminished results.",
    ...
    storyParagraph: "When conditioned, Gate 54 forces inspiration into form through sheer will, pushing hard on ideas that may not even be yours to build, or that haven't reached their right moment. The high expression cultivates a genuine relationship with the creative muse, holding inspiration gently, building the energetic and practical foundations for it, and trusting that stewardship of an idea is its own form of service. Not every inspiration is yours to build, but all of them deserve to be honored.",
  },
  55: {
    ...
    high: {
      short: "holding the emotional tone of a vision with enough faith to create without clinging or controlling",
      ...
      verb: "hold the emotional tone of a vision with enough faith to create without clinging or controlling",
      gerund: "holding the emotional tone of a vision with enough faith to create without clinging or controlling",
    },
    arc: {
  ...
  56: {
    ...
    high: {
      ...
      expanded: "A mastery of expansive narrative, stories and insights that orient people toward what might be possible, shift their emotional tone upward, and generate the kind of momentum that actually creates change.",
  ...
  64: {
    ...
    low: {
      short: "pressuring myself to make big ideas real, despairing when I can't figure out how to make them real",
      ...
      verb: "pressure myself to make big ideas real and despair when I can't figure out how to make them real",
      gerund: "pressuring myself to make big ideas real and despairing when I can't figure out how to make them real",
    },
    high: {
    ...
    arc: {
      short: "moving from straining to force every vision into being to trusting my role as a receiver and dreamer of what wants to come through",
      ...
      verb: "move from straining to force every vision into being to trusting my role as a receiver and dreamer of what wants to come through",
      gerund: "moving from straining to force every vision into being to trusting my role as a receiver and dreamer of what wants to come through",
    },
    storyParagraph: "Gate 64 conditioned feels the mental pressure to make big ideas real and despairs when it can't figure out how. There's an exhausting loop of imagining and straining to implement. The high expression understands that your role with a big idea may be to hold it, to give it your imagination, dream into it, and trust that the how will become clear if it's yours to build. Not every idea that moves through you is yours to execute; some you're simply here to carry until the right moment or person arrives.",
  },
};
